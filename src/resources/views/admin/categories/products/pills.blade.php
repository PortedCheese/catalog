    ...
    <ul class="nav nav-pills">
        <li class="nav-item">
            <a class="nav-link{{ $currentRoute == 'admin.category.product.show' ? ' active' : '' }}"
               href="{{ route('admin.category.product.show', [
                                            'category' => $category,
                                            'product' => $product
                                        ]) }}">
                Просмотр
        ...
        <li class="nav-item">
            <a class="nav-link{{ $currentRoute == 'admin.category.product.edit' ? ' active' : '' }}"
               href="{{ route('admin.category.product.edit', [
                                            'category' => $category,
                                            'product' => $product
                                        ]) }}">
                Редактировать
        ...
        <li class="nav-item">
            <a class="nav-link{{ strstr($currentRoute, 'admin.category.product.field') !== FALSE ? ' active' : '' }}"
               href="{{ route('admin.category.product.field.index', [
                                            'category' => $category,
                                            'product' => $product
                                        ]) }}">
                Характеристики
        ...
        <li class="nav-item">
            <a class="nav-link{{ $currentRoute == 'admin.category.product.metas' ? ' active' : '' }}"
               href="{{ route('admin.category.product.metas', [
                                            'category' => $category,
                                            'product' => $product
                                        ]) }}">
                Мета
        ...
        <li class="nav-item">
            <a class="nav-link{{ $currentRoute == 'admin.category.product.gallery' ? ' active' : '' }}"
               href="{{ route('admin.category.product.gallery', [
                                            'category' => $category,
                                            'product' => $product
                                        ]) }}">
                Галлерея
        ...
        <li class="nav-item">
            <a class="nav-link{{ strstr($currentRoute, 'admin.category.product.variation') !== FALSE ? ' active' : '' }}"
               href="{{ route('admin.category.product.variation.index', [
                                            'category' => $category,
                                            'product' => $product
                                        ]) }}">
                Вариации
